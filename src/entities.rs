...
/// The hero also has the ability to eat some magic cherries which 
...
/// the hero. When the hero eat magic cherries, then the villain
...
pub struct Seeds{}
/// This is a magic cherry. It can also be eated by the hero just like
/// the regular seeds. However, whenever the hero eats a cherry, all
